 ...
 *
 * Optional: README_CAPTURE_PASSWORD for a stable disposable signup password.
 * Otherwise a one-time random password is generated (never logged).
 *
...
function disposablePassword() {
  return (
    process.env.README_CAPTURE_PASSWORD ||
    `Rd${randomBytes(18).toString('base64url')}!9`
  )
}
